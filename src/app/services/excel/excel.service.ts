...
export class ExcelService {
  ...
  public exportToFile(fileName: string, element_id: string) {
    ...
    for(const property in wb.Sheets.Sheet1){
      if( wb.Sheets.Sheet1[property].hasOwnProperty('t')) wb.Sheets.Sheet1[property].t = 's';
    }
    //wb.Sheets.Sheet1.A2.t = 's';
    //wb.Sheets.Sheet1.A3.t = 's';
